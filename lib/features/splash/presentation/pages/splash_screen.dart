      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            TextRevealAnimation(
              text: "HOME",
              textStyle:res.isDesktop?AppTextStyles.poppinsDes58(
                context,
              ).copyWith(color: Colors.white): AppTextStyles.poppins58(
                context,
            ...
            TextRevealAnimation(
              text: "DECOR",
              textStyle:res.isDesktop?AppTextStyles.interDes33(
                context,
              ).copyWith(color: Colors.white, letterSpacing: 12): AppTextStyles.inter33(
                context,
